...
const classifications = [
  ...
  ["DYNAMIC_SERVER_USAGE", /Dynamic server usage|DYNAMIC_SERVER_USAGE/iu],
  ["REQUEST_CONTEXT", /outside (?:a )?request scope|getCloudflareContext.{0,120}(?:unavailable|not available|cannot|only)/iu],
  ["RSC_SERIALIZATION", /Only plain objects.{0,160}Client Components|Functions cannot be passed directly to Client Components/iu],
  ["REACT_RENDER", /Minified React error|Invalid hook call|Expected a suspended thenable/iu],
  ["MODULE_RESOLUTION", /Cannot find module|Cannot find package|ERR_MODULE_NOT_FOUND/iu],
  ["FETCH_FAILURE", /fetch failed|upstream connect error|ECONNRESET|ETIMEDOUT/iu],
  ["REQUEST_IO_CONTEXT", /Cannot perform I\/O on behalf of a different request|I\/O.{0,80}outside.{0,80}request handler/iu],
  ["INSPECTION_LOADER_INCOMPLETE", /Inspection settings loader result is incomplete/u],
