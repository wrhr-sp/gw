      ...
      try {
        ...
        const routine =
          ...
          /^[A-Za-z0-9_]{1,128}$/u.test(errorRecord.routine)
            ...
            : "NONE";
        diagnosticMarker = `PREVIEW_CALENDAR_TEMP_CLONE_SQLSTATE_${sqlstate}_CONSTRAINT_${constraint}_REASON_${safeReason}_REASON_SHA256_${reasonSha256}_ROUTINE_${routine}`;
      } finally {
        await transaction.unsafe(
