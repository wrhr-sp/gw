...
describe("mobile app shell admin boundary", () => {
  ...
  it("standardizes internal scrollbars and prevents first-paint scrollbar flicker", () => {
    ...
    expect(shellSource).toContain('topbar-modal-toast topbar-modal-toast--inline sidebar-settings-modal__toast');
    expect(shellSource).toContain('className="sidebar-settings-modal__toast-grid"');
    ...
    expect(globalCss).toContain(".sidebar-settings-modal__toast-grid");
    expect(globalCss).toContain("grid-template-columns: 360px minmax(0, 1fr)");
    expect(globalCss).toContain(".sidebar-settings-modal__toast-grid .sidebar-settings-modal__toast");
    expect(globalCss).toContain("justify-self: stretch");
