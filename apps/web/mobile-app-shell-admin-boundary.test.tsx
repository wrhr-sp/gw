...
describe("mobile app shell admin boundary", () => {
  ...
  it("standardizes internal scrollbars and prevents first-paint scrollbar flicker", () => {
    ...
    expect(shellSource).toContain('handleTopbarSettingsSave("변경된 내용이 없습니다.")');
    expect(shellSource).toContain('onClick={activeTopbarModal === "profile-settings" ? handleProfileSettingsSave : handleSettingsSave}');
    expect(shellSource).toContain('className="topbar-modal-toast"');
    ...
    expect(globalCss).toContain("width: calc(100% - 116px)");
    expect(globalCss).toContain("margin-left: 116px");
    expect(globalCss).toContain("padding-inline: 24px");
    expect(globalCss).toContain("width: calc(100% - 48px)");
