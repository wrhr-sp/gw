...
describe("mobile app shell admin boundary", () => {
  ...
  it("keeps selected feature icons and leaves branch portal without a menu icon", () => {
    ...
    expect(html).toContain('aria-label="기본업무 사이드바 편집"');
  ...
  it("keeps the PC sidebar portal split while replacing topbar portal switches with a department portal menu", () => {
    ...
    expect(generalHtml).toContain("기본업무");
    ...
    expect(generalHtml).toContain(`aria-label="We&#x27;reHere 기본업무 홈"`);
    ...
    expect(generalHtml).toContain('aria-label="기본업무 사이드바 편집"');
    expect(generalHtml).toContain('data-route="/home"');
    expect(generalHtml).not.toContain('data-route="/branches"');
    expect(generalHtml).toContain("조직도");
    expect(generalHtml).toContain("휴가");
    expect(generalHtml).toContain('data-route="/payroll/me"');
    ...
    expect(managementHtml).toContain("기본업무");
    ...
    expect(managementHtml).not.toContain('aria-label="기본업무 새 탭에서 보기"');
    ...
    expect(managementHtml).toContain(`aria-label="We&#x27;reHere 기본업무 홈"`);
    ...
    expect(managementHtml).toContain("기본업무");
    expect(managementHtml).not.toContain("급여 내부관리");
    ...
    expect(supportHtml).toContain('data-route="/management-support/hr?department=support"');
    expect(supportHtml).toContain('data-route="/management-support/branches?department=support"');
    expect(supportHtml).toContain('data-route="/management-support/payroll?department=support"');
    expect(supportHtml).toContain('data-route="/management-support/budget?department=support"');
    ...
    expect(supportHtml).not.toContain('data-route="/management-support/erp/expenses?department=support"');
    expect(supportHtml).not.toContain('data-route="/management-support/erp/vendors?department=support"');
    expect(supportHtml).not.toContain('data-route="/management-support/erp/billings?department=support"');
    ...
    expect(branchHtml).not.toContain('data-route="/attendance"');
    expect(branchHtml).toContain('data-route="/sales"');
    expect(branchHtml).not.toContain('class="desktop-sidebar__link" aria-label="메일" data-route="/mail"');
    expect(branchHtml).not.toContain('class="desktop-sidebar__link" aria-label="메신저" data-route="/messenger"');
    ...
    expect(supportSidebarItemsSource).toContain('href: "/management-support/hr"');
    expect(supportSidebarItemsSource).toContain('href: "/management-support/branches"');
    expect(supportSidebarItemsSource).toContain('href: "/management-support/payroll"');
    expect(supportSidebarItemsSource).toContain('href: "/management-support/budget"');
    expect(supportSidebarItemsSource).toContain('href: "/management-support/vendors"');
    expect(supportSidebarItemsSource).toContain('href: "/management-support/sales-purchases"');
    expect(supportSidebarItemsSource).toContain('href: "/management-support/attendance"');
    expect(supportSidebarItemsSource).not.toContain('href: "/admin/users"');
    expect(supportSidebarItemsSource).not.toContain('href: "/Place of business"');
    expect(supportSidebarItemsSource).not.toContain('href: "/payroll"');
    expect(supportSidebarItemsSource).not.toContain('href: "/attendance"');
    expect(supportSidebarItemsSource).not.toContain('href: "/management-support/erp/expenses"');
    expect(supportSidebarItemsSource).not.toContain('href: "/management-support/erp/vendors"');
    expect(supportSidebarItemsSource).not.toContain('href: "/management-support/erp/billings"');
  ...
  it("standardizes internal scrollbars and prevents first-paint scrollbar flicker", () => {
    ...
    expect(shellSource).toContain('function handleDesktopSidebarOutsidePointerDown(event: PointerEvent)');
    expect(shellSource).toContain('desktopSidebarRef.current?.contains(target)');
    expect(shellSource).toContain('document.addEventListener("pointerdown", handleDesktopSidebarOutsidePointerDown, true)');
    expect(shellSource).toContain('ref={desktopSidebarRef}');
    ...
    expect(shellSource).toContain('className="sidebar-settings-arrangement-button"');
    expect(shellSource).toContain('className="sidebar-settings-arrangement-actions"');
    expect(shellSource).toContain('className="sidebar-settings-arrangement-icon"');
    ...
    expect(shellSource).toContain('handleSidebarArrangementDragStart');
    expect(shellSource).toContain('handleSidebarArrangementDragOver');
    expect(shellSource).toContain('handleSidebarArrangementDrop');
    expect(shellSource).toContain('sidebar-settings-arrangement-row--drop-target');
    ...
    expect(globalCss).toContain(".sidebar-settings-arrangement-row--dragging");
    expect(globalCss).toContain(".sidebar-settings-arrangement-row--drop-target::before");
    ...
    expect(globalCss).toContain("grid-template-rows: auto minmax(0, 1fr)");
    expect(globalCss).toContain("grid-auto-rows: max-content");
    ...
    expect(globalCss).toContain("overflow: hidden");
    expect(globalCss).not.toContain(".sidebar-settings-arrangement-row--dragging {\n  opacity");
    expect(globalCss).not.toContain(".sidebar-settings-arrangement-row--dragging .sidebar-settings-arrangement-button {\n  cursor: grabbing;\n  outline");
    expect(globalCss).toContain(".sidebar-settings-arrangement-icon");
    ...
    expect(globalCss).toContain("--sidebar-settings-arrangement-row-width: 128px");
    expect(globalCss).toContain("--sidebar-settings-arrangement-row-columns: minmax(0, 76px) auto");
    expect(globalCss).toContain("--sidebar-settings-arrangement-button-width: 76px");
    expect(globalCss).toContain("--sidebar-settings-arrangement-button-min-height: clamp(34px, 5.1dvh, 42px)");
    expect(globalCss).toContain("--sidebar-settings-arrangement-action-size: clamp(20px, 1.9vw, 24px)");
    expect(globalCss).toContain("width: var(--sidebar-settings-arrangement-row-width)");
    expect(globalCss).toContain("grid-template-columns: var(--sidebar-settings-arrangement-row-columns)");
    expect(globalCss).toContain("width: var(--sidebar-settings-arrangement-button-width)");
    expect(globalCss).toContain("min-height: var(--sidebar-settings-arrangement-button-min-height)");
    expect(globalCss).toContain("width: var(--sidebar-settings-arrangement-action-size)");
