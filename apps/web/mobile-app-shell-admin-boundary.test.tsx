...
describe("mobile app shell admin boundary", () => {
  ...
  it("standardizes internal scrollbars and prevents first-paint scrollbar flicker", () => {
    ...
    expect(globalCss).toContain("--desktop-topbar-height: 56px");
    ...
    expect(globalCss).toContain("min-height: 30px");
    expect(globalCss).toContain("padding-inline: 10px");
    ...
    expect(globalCss).toContain("--desktop-sidebar-expanded-width: 260px");
    expect(globalCss).toContain("--desktop-content-padding-inline: clamp(7px, 0.8vw, 13px)");
    expect(globalCss).toContain("--desktop-grid-min: clamp(176px, 12.5vw, 200px)");
    expect(globalCss).toContain("--desktop-grid-compact-min: clamp(144px, 10.2vw, 164px)");
    expect(globalCss).toContain("--desktop-summary-grid-min: clamp(204px, 14.8vw, 236px)");
