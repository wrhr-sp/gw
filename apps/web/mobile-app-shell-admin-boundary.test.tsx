...
describe("mobile app shell admin boundary", () => {
  ...
  it("standardizes internal scrollbars and prevents first-paint scrollbar flicker", () => {
    ...
    expect(globalCss).toContain("--phase5-topbar-settings-gate__card-width-e114b: min(320px, 100%);");
    expect(globalCss).toContain("width: var(--phase5-topbar-settings-gate__card-width-e114b);");
    ...
    expect(globalCss).toContain("--phase5-pin-field__label-width-a04c7: min(260px, 100%);");
    expect(globalCss).toContain("width: var(--phase5-pin-field__label-width-a04c7);");
    expect(globalCss).toContain("--phase5-pin-field__label-min-height-1a3fa: 36px;");
    expect(globalCss).toContain("min-height: var(--phase5-pin-field__label-min-height-1a3fa);");
    ...
    expect(globalCss).toContain("--phase5-page-shell__content-min-height-d03ec: min(680px, calc(100dvh - 190px));");
    expect(globalCss).toContain("min-height: var(--phase5-page-shell__content-min-height-d03ec);");
    expect(globalCss).toContain("padding: 0;");
    expect(globalCss).toContain("@media (max-height: 760px)");
    expect(globalCss).toContain("--phase5-page-shell__content-min-height-11e80: min(520px, calc(100dvh - 170px));");
    expect(globalCss).toContain("min-height: var(--phase5-page-shell__content-min-height-11e80);");
    ...
    expect(globalCss).toContain("--phase5-topbar-modal-width-d5197: calc(100vw - var(--layer-modal-inset) - var(--layer-modal-inset));");
    expect(globalCss).toContain("--phase5-topbar-modal-height-bd0fd: calc(100dvh - var(--layer-modal-inset) - var(--layer-modal-inset));");
    expect(globalCss).toContain("--phase5-topbar-modal-max-height-b1b53: calc(100dvh - var(--layer-modal-inset) - var(--layer-modal-inset));");
    expect(globalCss).toContain("width: var(--phase5-topbar-modal-width-d5197);");
    expect(globalCss).toContain("height: var(--phase5-topbar-modal-height-bd0fd);");
    expect(globalCss).toContain("max-height: var(--phase5-topbar-modal-max-height-b1b53);");
    ...
    expect(globalCss).toContain("--phase5-topbar-profile-settings-scrollbar-color-d2a67: rgba(37, 99, 235, 0.38) transparent;");
    expect(globalCss).toContain("scrollbar-color: var(--phase5-topbar-profile-settings-scrollbar-color-d2a67);");
    ...
    expect(globalCss).toContain("--phase5-topbar-profile-settings-background-03748: linear-gradient(180deg, rgba(37, 99, 235, 0.44), rgba(96, 165, 250, 0.2));");
    expect(globalCss).toContain("--desktop-topbar-height: 50px");
    expect(globalCss).toContain("margin-top: var(--desktop-topbar-height)");
    expect(globalCss).toContain("--phase5-app-shell__main-height-d0ae3: calc(100dvh - var(--desktop-topbar-height));");
    expect(globalCss).toContain("--phase5-desktop-sidebar-height-04196: calc(100dvh - var(--desktop-topbar-height));");
    expect(globalCss).toContain("height: var(--phase5-app-shell__main-height-d0ae3);");
    expect(globalCss).toContain("height: var(--phase5-desktop-sidebar-height-04196);");
    expect(globalCss).toContain("--phase5-app-shell__main-scroll-padding-top-18894: 24px;");
    expect(globalCss).toContain("scroll-padding-top: var(--phase5-app-shell__main-scroll-padding-top-18894);");
    ...
    expect(globalCss).toContain("--phase5-desktop-sidebar__link-min-height-593d1: 40px;");
    expect(globalCss).toContain("min-height: var(--phase5-desktop-sidebar__link-min-height-593d1);");
    expect(globalCss).toContain("--phase5-desktop-sidebar__settings-button-min-height-ea6a8: 27px;");
    expect(globalCss).toContain("min-height: var(--phase5-desktop-sidebar__settings-button-min-height-ea6a8);");
    expect(globalCss).toContain("--phase5-desktop-sidebar__settings-button-padding-c1144: 5px 4px;");
    expect(globalCss).toContain("padding: var(--phase5-desktop-sidebar__settings-button-padding-c1144);");
    ...
    expect(globalCss).toContain("--phase5-topbar-modal-toast-border-5ce45: 1px solid rgba(191, 219, 254, 0.8);");
    expect(globalCss).toContain("--phase5-topbar-modal-toast-background-4d8c0: rgba(239, 246, 255, 0.94);");
    expect(globalCss).toContain("color: var(--primary-hover);");
    expect(globalCss).toContain(".topbar-modal-toast--no-change");
    expect(globalCss).toContain("--phase5-topbar-modal-toast-no-change-border-color-9391d: rgba(254, 202, 202, 0.9);");
    expect(globalCss).toContain("--phase5-topbar-modal-toast-no-change-background-337e0: rgba(254, 242, 242, 0.96);");
    ...
    expect(globalCss).toContain("--phase5-app-topbar__inner-width-248d1: calc(100% - var(--desktop-sidebar-collapsed-width) - var(--desktop-sidebar-collapsed-width));");
    expect(globalCss).toContain("width: var(--phase5-app-topbar__inner-width-248d1);");
