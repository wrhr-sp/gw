  ...
  events: [
    {
      ...
      detailHref: `/hotels/${calendarHotelId}/inspections`,
      endsAt: null,
      hotelId: calendarHotelId,
      hotelName: "서울호텔",
      id: "60000000-0000-4000-8000-000000000001",
      startsAt: "2026-08-07T09:00:00.000Z",
      status: "PENDING_INPUT" as const,
      targetSummary: "객실 2개 대상",
      title: "점검 마감",
    ...
    },
    {
      ...
      canUpdate: true,
      detailHref: `/hotels/${calendarHotelId}/repairs`,
      endsAt: "2026-08-07T11:00:00.000Z",
      hotelId: calendarHotelId,
      hotelName: "서울호텔",
      id: "a2000000-0000-4000-8000-000000000001",
      priority: { color: "RED", name: "긴급" },
...
export function CalendarWorkspaceStory() {
  ...
  return (
    <QueryClientProvider client={client}>
      <CalendarWorkspace
        initialData={calendarStoryData}
        initialScope={{ hotelId: calendarHotelId, mode: "HOTEL" }}
      />
    </QueryClientProvider>
  );
}

export function CalendarConnectionStory(
  props: React.ComponentProps<typeof CalendarConnectionPanel>,
) {
  return <CalendarConnectionPanel {...props} />;
}
