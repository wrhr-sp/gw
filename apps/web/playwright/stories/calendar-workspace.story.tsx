...
export const calendarStoryData = {
  ...
  events: [
    ...
    { calendarProjectionStatus: "NOT_CONNECTED" as const, cancellationReason: null, canUpdate: true, detailHref: `/hotels/${calendarHotelId}/repairs`, endsAt: "2026-08-07T11:00:00.000Z", hotelId: calendarHotelId, hotelName: "서울호텔", id: "a2000000-0000-4000-8000-000000000001", priority: { color: "RED", name: "긴급" }, startsAt: "2026-08-07T10:00:00.000Z", status: "SCHEDULED" as const, targetSummary: "703호", title: "배관 점검", type: "REPAIR_VISIT" as const },
  ],
