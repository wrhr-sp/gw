...
describe("Phase 14 home/login flow", () => {
  it("turns the home page into a flow overview for general work and admin review", () => {
    ...
    expect(html).toContain("/dashboard 관리자 CTA → /management → /work-items/branch → /admin/users · /admin/policies · /admin/audit-logs");
  ...
  it("keeps the login page honest about dev-safe auth while explaining role-based next routes", () => {
    ...
    expect(html).toContain("/dashboard → /management → /work-items/branch → /admin/users → /admin/policies → /admin/audit-logs");
