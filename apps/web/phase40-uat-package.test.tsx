...
describe("Phase 40 internal adoption rehearsal package", () => {
  it("renders access info, role scenarios, issue template, facilitator guide, and approval gates in one page", () => {
    ...
    expect(html).toContain("https://gw-web-preview.wereheresp.workers.dev");
    ...
    expect(html).toContain("/management → /management-support/hr → /admin/policies → /payroll → /work-items/tax → /work-items/labor → /work-items/legal → /admin/audit-logs → /api/health");
