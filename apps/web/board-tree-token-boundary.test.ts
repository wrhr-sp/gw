...
describe("board tree compact token baseline", () => {
  it("keeps the left board tree spacing, weights, and unread badge on dedicated tokens", () => {
    ...
    expect(globalCss).toContain("--board-tree-parent-font-size: calc(var(--font-size-page-title) - 3px);");
    ...
    expect(globalCss).toContain("font-size: var(--feature-page-count-badge-font-size);");
