...
describe("org/employees/admin boundaries", () => {
  ...
  it("keeps management support employee management list-first and opens creation in the right detail panel", async () => {
    ...
    expect(clientSource).toContain("프로필사진 설정");
    ...
    expect(clientSource).toContain("employee-create-assignment-tabs");
    expect(clientSource).toContain("사원 기본 겸직 입력 그룹");
    expect(clientSource).toContain("handleAddConcurrentAssignment");
    expect(clientSource).toContain("label: `겸직 ${current.concurrentAssignments.length + 1}`");
  ...
  it("styles employee detail as a right-side panel with top entrance motion", async () => {
    ...
    expect(globalCss).toContain(".employee-create-assignment-tabs");
    expect(globalCss).toContain(".employee-create-assignment-tabs__item");
    expect(globalCss).toContain(".employee-create-section-divider");
