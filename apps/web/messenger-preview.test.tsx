...
describe("messenger preview page", () => {
  it("renders the board-like content title with conversation list and chat room columns plus a hidden new-message org popup", () => {
    ...
    expect(html).toContain("전체 문서함 선택 목록");
    expect(html).toContain("문서함 분류");
    expect(html).toContain("공지/규정");
    expect(html).toContain("인사/근태");
    expect(html).toContain("업무자료");
    expect(html).toContain("양식");
    expect(html).toContain("전사 공지문.docx");
    ...
    expect(html).toContain("이모티콘 분류");
    expect(html).toContain("자주사용 이모티콘 목록");
    expect(html).toContain("표정");
    expect(html).toContain("반응");
    expect(html).toContain("업무");
    expect(html).toContain("상태");
    expect(html).toContain("기념");
