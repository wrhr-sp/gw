...
describe("feature page content spacing baseline", () => {
  it("keeps desktop feature pages on the shared PageShell spacing model", () => {
    ...
    expect(globalCss).toContain("--feature-page-content-outer-gap: 12px;");
    expect(globalCss).toContain("--feature-page-outer-gap-block: var(--feature-page-content-outer-gap);");
    expect(globalCss).toContain("--feature-page-outer-gap-inline: var(--feature-page-content-outer-gap);");
    ...
    expect(globalCss).toContain("--feature-page-content-overflow-y: auto;");
    expect(globalCss).toContain("--feature-page-title-font-size: var(--font-size-page-title);");
    expect(globalCss).toContain("--feature-page-title-font-weight: var(--font-weight-page-title);");
    expect(globalCss).toContain("--feature-page-title-letter-spacing: var(--letter-spacing-feature-title);");
    expect(globalCss).toContain("--feature-page-content-title-font-size: var(--font-size-content-title);");
    expect(globalCss).toContain("--feature-page-content-title-font-weight: var(--font-weight-content-title);");
    expect(globalCss).toContain("--feature-page-content-title-letter-spacing: var(--letter-spacing-feature-title);");
    expect(globalCss).toContain("--feature-page-description-margin: var(--board-post-row-margin);");
    expect(globalCss).toContain("--feature-page-description-color: var(--text-muted);");
    expect(globalCss).toContain("--feature-page-description-font-size: var(--font-size-md);");
    expect(globalCss).toContain("--feature-page-description-line-height: var(--line-height-readable);");
    expect(globalCss).toContain("--feature-page-content-bg: var(--surface);");
    expect(globalCss).toContain("--feature-page-content-border: var(--page-shell-content-border);");
    expect(globalCss).toContain("--feature-page-content-radius: var(--radius-xl);");
    expect(globalCss).toContain("--feature-page-content-shadow: var(--shadow);");
    expect(globalCss).toContain("--feature-page-content-padding: var(--content-padding);");
    expect(globalCss).toContain("--feature-page-content-title-border-top: 1px solid var(--line);");
    expect(globalCss).toContain("--page-shell-content-border-top: var(--feature-page-content-title-border-top);");
    expect(globalCss).toContain("--feature-page-section-divider: var(--surface-card-border-top);");
    expect(globalCss).toContain("--feature-page-section-divider-margin-top: var(--space-xl);");
    expect(globalCss).toContain("--feature-page-section-divider-padding-top: var(--space-xl);");
    expect(globalCss).toContain("--feature-page-nested-grid-gap: var(--grid-gap);");
    expect(globalCss).toContain("--feature-page-nested-card-bg: transparent;");
    expect(globalCss).toContain("--feature-page-nested-card-border: 0;");
    expect(globalCss).toContain("--feature-page-nested-card-radius: 0;");
    expect(globalCss).toContain("--feature-page-nested-card-padding: 0;");
    expect(globalCss).toContain("--feature-workspace-control-border: 1px solid rgba(148, 163, 184, 0.34);");
    expect(globalCss).toContain("--feature-workspace-control-radius: 10px;");
    expect(globalCss).toContain("--feature-workspace-control-bg: rgba(255, 255, 255, 0.76);");
    expect(globalCss).toContain("--feature-workspace-control-padding: 10px 12px;");
    ...
    expect(globalCss).toContain("--board-home-tab-group-gap: 3px;");
    ...
    expect(globalCss).toContain("--board-home-tab-font-weight: var(--font-weight-semibold);");
    expect(globalCss).toContain("--board-home-tab-font-variation-settings: \"wght\" 600;");
    ...
    expect(globalCss).toContain("padding-inline: 0");
    ...
    expect(globalCss).toContain("background: var(--feature-page-content-bg);");
    ...
    expect(globalCss).toContain("padding: var(--feature-page-outer-gap-block) var(--feature-page-outer-gap-inline);");
    ...
    expect(globalCss).toContain("font-size: var(--feature-page-title-font-size);");
    expect(globalCss).toContain("font-weight: var(--feature-page-title-font-weight);");
    expect(globalCss).toContain("letter-spacing: var(--feature-page-title-letter-spacing);");
    expect(globalCss).toContain("font-size: var(--feature-page-content-title-font-size);");
    expect(globalCss).toContain("font-weight: var(--feature-page-content-title-font-weight);");
    expect(globalCss).toContain("letter-spacing: var(--feature-page-content-title-letter-spacing);");
    expect(globalCss).toContain("margin: var(--feature-page-description-margin);");
    expect(globalCss).toContain("color: var(--feature-page-description-color);");
    expect(globalCss).toContain("font-size: var(--feature-page-description-font-size);");
    expect(globalCss).toContain("line-height: var(--feature-page-description-line-height);");
    ...
    expect(globalCss).toContain("max-height: var(--feature-page-content-height);");
    expect(globalCss).toContain("overflow-y: var(--feature-page-content-overflow-y);");
    ...
    expect(globalCss).toContain("color: var(--text-muted);");
    ...
    expect(globalCss).toContain(".feature-workspace__nav-header h1 {");
    expect(globalCss).toContain("font-size: var(--feature-page-title-font-size);");
    expect(globalCss).toContain("font-weight: var(--feature-page-title-font-weight);");
    expect(globalCss).toContain("letter-spacing: var(--feature-page-title-letter-spacing);");
    expect(globalCss).toContain(".surface-card__header h2,");
    expect(globalCss).toContain(".feature-workspace__panel-header h2 {");
    expect(globalCss).toContain("font-size: var(--feature-page-content-title-font-size);");
    expect(globalCss).toContain("font-weight: var(--feature-page-content-title-font-weight);");
    expect(globalCss).toContain("letter-spacing: var(--feature-page-content-title-letter-spacing);");
