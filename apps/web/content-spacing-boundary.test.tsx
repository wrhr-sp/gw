...
describe("feature page content spacing baseline", () => {
  it("keeps desktop feature pages on the shared PageShell spacing model", () => {
    ...
    expect(globalCss).toContain("--ui-inline-gap-sm: 8px;");
    expect(globalCss).toContain("--ui-inline-gap-md: 12px;");
    expect(globalCss).toContain("--ui-filter-grid-min-column: 140px;");
    expect(globalCss).toContain("--ui-filter-grid-columns: repeat(auto-fit, minmax(var(--ui-filter-grid-min-column), 1fr));");
    expect(globalCss).toContain("--ui-split-view-height: 100%;");
    expect(globalCss).toContain("--ui-split-view-overflow: hidden;");
    ...
    expect(globalCss).toContain(".feature-workspace__nav-header,");
    expect(globalCss).toContain("align-items: center;");
    expect(globalCss).toContain("gap: var(--ui-inline-gap-md);");
    expect(globalCss).toContain(".board-workspace__nav-header,");
    expect(globalCss).toContain(".mail-search-filter-bar {");
    expect(globalCss).toContain("grid-template-columns: var(--ui-filter-grid-columns);");
    expect(globalCss).toContain(".mail-detail-layout {");
    expect(globalCss).toContain("height: var(--ui-split-view-height);");
    expect(globalCss).toContain("overflow: var(--ui-split-view-overflow);");
