    ...
    panels: [
      {
        id: "employees",
        heading: "사원정보관리",
        summary: "신규 입사부터 퇴사까지의 사원 생애주기를 경영지원팀 업무 기준으로 관리합니다.",
        rows: [
          { title: "입사·계정 생성", meta: "소항목", status: "경영지원팀 업무" },
          { title: "사원 기본정보 관리", meta: "소항목", status: "경영지원팀 업무" },
          { title: "퇴사 처리", meta: "소항목", status: "경영지원팀 업무" },
        ],
        permissionHint: "기본업무 내정보나 관리자 계정관리로 이동하지 않는 경영지원팀 전용 진입점입니다.",
      },
      {
        id: "appointments",
        heading: "인사발령",
