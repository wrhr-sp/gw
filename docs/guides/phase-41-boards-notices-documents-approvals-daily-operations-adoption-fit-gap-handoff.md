...
"지금 바로 내부 도입 가능한 것 / 아직 Production-ready (실구현) 인 것 / 별도 승인 필요한 것"
세 갈래로 다시 고정하는 단계다.
...
- 승인/반려 action 은 서버 검증 전 Production-ready (실구현) 라는 점을 숨기지 않되,
...
4. 현재 가능한 것과 아직 Production-ready (실구현) 인 것, 승인 게이트가 분리돼 있다.
