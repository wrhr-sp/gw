...
현재 문서화 기준으로는 Phase 18 네이티브 모바일앱 핵심 업무 연결 1차가 최신 범위이며, Phase 17에서 만든 `apps/mobile` skeleton과 shared contract 위에 로그인·대시보드·출퇴근·휴가·결재함·공지/문서·내 정보 흐름, 상태 분류, dev-safe 검증 기준, 승인 게이트를 한 번에 따라가게 만드는 작업을 이어간다.
...
- 현재 기준 범위: `docs/architecture/phase-18-native-mobile-core-workflows-pass-1-scope.md`
- 현재 쉬운 handoff: `docs/guides/phase-18-native-mobile-core-workflows-pass-1-handoff.md`
