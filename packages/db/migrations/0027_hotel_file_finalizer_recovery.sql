-- Forward-only recovery for a clean file whose finalizer process stops after scan recording.
-- The original 0026 migration remains immutable.
...
values ('0027_hotel_file_finalizer_recovery')
